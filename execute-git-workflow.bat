...
powershell -Command "(Get-Content README.md) -replace '- Basic arithmetic operations', '- Feature One Implemented' | Set-Content README.md"
...
powershell -Command "(Get-Content README.md) -replace '- Basic arithmetic operations', '- Feature Two Added' | Set-Content README.md"
